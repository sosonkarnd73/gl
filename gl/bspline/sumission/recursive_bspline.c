...
int* getvert(GLuint* vbo)
{
  ...
  */
     ...
     double p11=0.0, p12=0.0, p21=0.0, p22=0.0, area= 0.0, length = 0.0;
     scanf("%lf%lf%lf%lf",&p11,&p12,&p21,&p22);                    //points in which we need to get the curve length and area percentage
