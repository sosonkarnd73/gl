...
glm::vec3 vertexnormal[21][21];
glm::vec3 facenormal[20][20];
...
void vertexNormal(){
     ...
     for (int i = 1; i < numSegment; i++){
	  ...
	  vertexnormal[i][19] = (facenormal[i - 1][18] + facenormal[i][18]) * 0.5f;
	  vertexnormal[19][i] = (facenormal[18][i-1] + facenormal[18][i]) * 0.5f;
     }
     //others
...
void createObject(char* objfile)
{
     ...
     for (int i = 0; i < numSegment-1; i++){
	  for (int j = 0; j < numSegment-1; j++){
	       outputfile<<"n "<<vertexnormal[i][j + 1].x <<" "<< vertexnormal[i][j + 1].y <<" "<< vertexnormal[i][j + 1].z<<endl;
	       outputfile<<"v "<<P[i][j + 1].x<<" "<<P[i][j + 1].y<<" "<<P[i][j + 1].z<<endl;
			  
	       outputfile<<"n "<<vertexnormal[i + 1][j].x <<" "<< vertexnormal[i + 1][j].y <<" "<< vertexnormal[i + 1][j].z<<endl;
	       outputfile<<"v "<<P[i + 1][j].x<<" "<<P[i + 1][j].y<<" "<<P[i + 1][j].z<<endl;
	       ...
	       outputfile<<"v "<<P[i][j + 1].x<<" "<<P[i][j + 1].y<<" "<<P[i][j + 1].z<<endl;
	       outputfile<<"n "<<vertexnormal[i][j].x <<" "<< vertexnormal[i][j].y <<" "<< vertexnormal[i][j].z<<endl;
	       outputfile<<"v "<<P[i + 1][j + 1].x<<" "<<P[i + 1][j + 1].y<<" "<<P[i + 1][j + 1].z<<endl;
	  }
     }
}
